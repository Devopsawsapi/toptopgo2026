...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 border-l-4 border-l-blue-500">
            ...
            <div class="text-3xl font-bold text-gray-800"><?php echo e($stats['total_users']); ?></div>
            <div class="text-xs text-green-500 mt-1">+<?php echo e($stats['new_users_today']); ?> aujourd'hui</div>
        </div>
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 border-l-4 border-l-yellow-400">
            ...
            <div class="text-3xl font-bold text-yellow-500"><?php echo e($stats['active_drivers']); ?></div>
            <div class="text-xs text-green-500 mt-1"><?php echo e($stats['online_drivers']); ?> en ligne</div>
        </div>
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 border-l-4 border-l-gray-800">
            ...
            <div class="text-3xl font-bold text-gray-800"><?php echo e($stats['today_rides']); ?></div>
            <div class="text-xs text-gray-400 mt-1"><?php echo e($stats['active_rides']); ?> en cours</div>
        </div>
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 border-l-4 border-l-green-500">
            ...
            <div class="text-2xl font-bold text-green-600"><?php echo e(number_format($stats['today_revenue'], 0, ',', ' ')); ?> XAF</div>
            <div class="text-xs text-gray-400 mt-1">Commission : <?php echo e(number_format($stats['today_commission'], 0, ',', ' ')); ?> XAF</div>
        </div>
    </div>
...
// CONFIGURATION
// ================================================================
const LIVE_URL  = "<?php echo e(route('admin.drivers.live')); ?>";
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\SMART\Desktop\Nouveau dossier\Backendtoptopgo\Backendtoptopgo\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>