...
<div class="p-6">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4 mb-6">
        <form method="GET" action="<?php echo e(route('admin.support.users.index')); ?>" class="flex gap-3 items-center">
            <div class="flex-1">
    ...
    <div class="flex gap-4" style="height: 65vh;">
        ...
        <div class="w-1/3 bg-white rounded-xl shadow-sm border border-gray-100 flex flex-col overflow-hidden">
            ...
            <div class="overflow-y-auto flex-1">
                <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <a href="<?php echo e(route('admin.support.users.show', array_merge(['user' => $u->id], $params))); ?>"
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div class="relative flex-shrink-0">
                                <div class="w-10 h-10 rounded-full flex items-center justify-center text-sm font-bold
                                    <?php echo e($hasMsg ? 'bg-indigo-200 text-indigo-800' : 'bg-gray-100 text-gray-500'); ?>">
                                    <?php echo e(strtoupper(substr($u->first_name ?? 'U', 0, 1))); ?>
            ...
            <?php if($users->hasPages()): ?>
                <div class="p-3 border-t border-gray-100 text-center">
                    <?php echo e($users->appends(request()->query())->links('pagination::simple-tailwind')); ?>
        ...
        <div class="flex-1 bg-white rounded-xl shadow-sm border border-gray-100 flex flex-col overflow-hidden">
            ...
            <?php if(isset($user) && isset($messages)): ?>
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <div class="text-xs text-gray-400">
                                <?php echo e($user->phone ?? $user->email ?? '—'); ?>
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <div class="text-center text-gray-400 py-10">
                            ...
                            <p class="text-sm mt-1">
                                ...
                                <span class="font-semibold text-indigo-600"><?php echo e($user->first_name); ?></span>
                                ci-dessous
                            </p>
                        </div>
                    <?php endif; ?>
                ...
                <div class="p-4 border-t border-gray-100 bg-white">
                    <form method="POST" action="<?php echo e(route('admin.support.users.send', $user->id)); ?>"
                        ...
                        <div class="flex-1">
                            <textarea name="content" rows="2"
                                placeholder="Écrire un message à <?php echo e($user->first_name); ?>..."
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\SMART\Desktop\Nouveau dossier\Backendtoptopgo\Backendtoptopgo\resources\views/admin/messages/admin-user.blade.php ENDPATH**/ ?>